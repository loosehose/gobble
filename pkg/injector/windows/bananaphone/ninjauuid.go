...
func (e *NinjaUUID) RenderInstanciationCode(data embed.FS) (string, error) {
	...
	return common.CommonRendering(data, "templates/injector/windows/bananaphone/local/ninjauuid/instanciation.go.tmpl", e)
}

func (e *NinjaUUID) RenderFunctionCode(data embed.FS) (string, error) {

	return common.CommonRendering(data, "templates/injector/windows/bananaphone/local/ninjauuid/functions.go.tmpl", e)
}
